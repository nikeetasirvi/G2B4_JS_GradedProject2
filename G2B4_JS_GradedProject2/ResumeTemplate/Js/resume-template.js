//we have a data object variable as well which is included through script in html page
let dataObj = { resume: [] };
...
const preStrtDate = document.getElementById("preStrtDate");
const preEndDate = document.getElementById("preEndDate");
const preSumm = document.getElementById("preSumm");
...
const intStrtDate = document.getElementById("intStrtDate");
const intEndDate = document.getElementById("intEndDate");
const intSumm = document.getElementById("intSumm");
const intPos = document.getElementById("intPos");

const achi = document.getElementById("achi");
...
function getResumes() {
  fetch("../Resources/Data/data.json")
    ...
    .catch(error => {
      alert(
        `Page Unable to load file "${error.message}". Please click on OK to Load the data from local.`
      );
      dataObj = data;
      resumes = dataObj['resume'];
      fillData();
...
function fillData() {
  ...
  preStrtDate.innerHTML = `<strong>Company Name: </strong>${resume.work["Start Date"]}`;
  preEndDate.innerHTML = `<strong>End Date: </strong>${resume.work["End Date"]}`;
  preSumm.innerHTML = `<strong>Summary: </strong>${resume.work.Summary}`;
  ...
  intStrtDate.innerHTML = `<strong>Company Name: </strong>${resume.Internship["Start Date"]}`;
  intEndDate.innerHTML = `<strong>End Date: </strong>${resume.Internship["End Date"]}`;
  intSumm.innerHTML = `<strong>Summary: </strong>${resume.Internship.Summary}`;
  intPos.innerHTML = `<strong>Position: </strong>${resume.Internship.Position}`;

  achi.innerText = resume.achievements.Summary;
}
